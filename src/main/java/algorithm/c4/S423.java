    ...
    public String originalDigits(String s) {
        ...
        if (charMap['z' - 'a'] > 0) {
            ...
            for (int i = 0; i < result[0]; i++) {
                arrSub(charMap, numberCharMap.get(0));
            }
        }
        // w 2
        if (charMap['w' - 'a'] > 0) {
            ...
            for (int i = 0; i < result[2]; i++) {
                arrSub(charMap, numberCharMap.get(2));
            }
        }
        // x 6
        if (charMap['x' - 'a'] > 0) {
            ...
            for (int i = 0; i < result[6]; i++) {
                arrSub(charMap, numberCharMap.get(6));
            }
        }
        // g 8
        if (charMap['g' - 'a'] > 0) {
            ...
            for (int i = 0; i < result[8]; i++) {
                arrSub(charMap, numberCharMap.get(8));
            }
        }
        // 3
        if (charMap['t' - 'a'] > 0) {
            ...
            for (int i = 0; i < result[3]; i++) {
                arrSub(charMap, numberCharMap.get(3));
            }
        }
        // 4
        if (charMap['r' - 'a'] > 0) {
            ...
            for (int i = 0; i < result[4]; i++) {
                arrSub(charMap, numberCharMap.get(4));
            }
        }
        // 1
        if (charMap['o' - 'a'] > 0) {
            ...
            for (int i = 0; i < result[1]; i++) {
                arrSub(charMap, numberCharMap.get(1));
            }
        }
        // 5
        if (charMap['f' - 'a'] > 0) {
            ...
            for (int i = 0; i < result[5]; i++) {
                arrSub(charMap, numberCharMap.get(5));
            }
        }
        // 7
        if (charMap['s' - 'a'] > 0) {
            result[7] = charMap['s' - 'a'];
            for (int i = 0; i < result[7]; i++) {
                arrSub(charMap, numberCharMap.get(7));
            }
        }
        // 9
        if (charMap['i' - 'a'] > 0) {
            ...
            for (int i = 0; i < result[9]; i++) {
                arrSub(charMap, numberCharMap.get(9));
            }
        }
